        ...
        (loop [i 0]
          (when (< i n)
            (let [idx (if priority i (aget idxs i))
                  ...
                  vbox (if wport
                         (let [val (port 1)]
                           (dp/-put! wport val (alt-handler flag #(fret [% wport]))))
...
;;; Populate dunaj.concurrent.port
...
(replace-macro! dunaj.concurrent.port/go (var go))
(replace-var! dunaj.concurrent.port/thread-call)
(replace-var! dunaj.concurrent.port/fn-handler)
(replace-var! dunaj.concurrent.port/<!!)
(replace-var! dunaj.concurrent.port/>!!)
(replace-var! dunaj.concurrent.port/chan)
(replace-var! dunaj.concurrent.port/timeout)
(replace-var! dunaj.concurrent.port/alts!!)
(replace-var! dunaj.concurrent.port/alts!)
(replace-macro! dunaj.concurrent.port/alt!! (var alt!!))
(replace-macro! dunaj.concurrent.port/alt! (var alt!))
(replace-var! dunaj.concurrent.port/map! map)
(replace-var! dunaj.concurrent.port/map<)
(replace-var! dunaj.concurrent.port/map>)
(replace-var! dunaj.concurrent.port/filter>)
(replace-var! dunaj.concurrent.port/filter<! filter<)
(replace-var! dunaj.concurrent.port/mapcat<! mapcat<)
(replace-var! dunaj.concurrent.port/mapcat>)
...
(replace-var! dunaj.concurrent.port/unique! unique)
(replace-var! dunaj.concurrent.port/partition! partition)
(replace-var! dunaj.concurrent.port/partition-by! partition-by)
...
(replace-var! dunaj.concurrent.port/untap! untap)
(replace-var! dunaj.concurrent.port/untap-all! untap-all)
(replace-var! dunaj.concurrent.port/mix mix)
(replace-var! dunaj.concurrent.port/admix! admix)
(replace-var! dunaj.concurrent.port/unmix! unmix)
(replace-var! dunaj.concurrent.port/unmix-all! unmix-all)
(replace-var! dunaj.concurrent.port/toggle! toggle)
(replace-var! dunaj.concurrent.port/pub! pub)
(replace-var! dunaj.concurrent.port/sub! sub2)
(replace-var! dunaj.concurrent.port/unsub! unsub)
(replace-var! dunaj.concurrent.port/unsub-all! unsub-all)
